...
type AOA = any[][];
@Component({
  selector: 'app-carga-interna',

  templateUrl: './carga-interna.component.html',
  styleUrl: './carga-interna.component.css',
})
export class CargaInternaComponent implements OnInit {
  barcodeValue: string;
